...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Drone Configurator'),
        centerTitle: true,
      ),
      body: Center(
        child: Column(
          ...
          children: [
            Text(
              connection.isConnected ? 'Connected to FC' : 'Disconnected',
              style: TextStyle(
            ...
            ElevatedButton(
                ...
                if (kIsWeb) {
                  showDialog(
                    ...
                    builder: (_) => AlertDialog(
                      ...
                      content: const Text(
                        'Connect to DroneFC WiFi (SSID: DroneFC, Password: password), then tap Connect.',
                      ),
                      actions: [
                        TextButton(
              ...
              child: Text(connection.isConnected
                  ? 'Disconnect'
            ...
            Expanded(
              child: GridView.count(
                ...
                children: [
                  ElevatedButton(
                    onPressed: () => Navigator.pushNamed(context, '/pid'),
                  ...
                  ElevatedButton(
                    onPressed: () => Navigator.pushNamed(context, '/3d'),
                  ...
                  ElevatedButton(
                    onPressed: () => Navigator.pushNamed(context, '/cli'),
                    child: const Text('CLI'),
                  ),
                  ElevatedButton(
                    onPressed: () => Provider.of<LoggerService>(context, listen: false).exportLog(),
